...
class MoneyControlHistorical(BaseExtractor):
    ...
    def parseMoneyControl(self, db) -> int:
        ...
        for cursor in range(start_cursor, end_cursor + 1):
            ...
            data_url = f'https://www.moneycontrol.com/news/business/stocks/page-{cursor}'
    
            news_links_soup = self.get_soup(data_url)
